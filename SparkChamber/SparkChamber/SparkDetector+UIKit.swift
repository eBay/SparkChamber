...
Functions allow the tracking of a view's appearance, disappearance, touches (ended), scrolling (began), responder status (became, resigned), and target action.
*/
#if os(iOS)
extension SparkDetector {
	...
	*/
	...
	- parameter scrollView: A UIScrollView to process
