...
//! Project version number for SparkKit.
FOUNDATION_EXPORT double SparkKitVersionNumber;

//! Project version string for SparkKit.
...
#import <SparkKit/SparkCollectionViewCell.h>
#import <SparkKit/SparkTableViewCell.h>
